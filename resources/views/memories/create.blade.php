...
<head>
    ...
    <title>Add Memory - Dear Diary</title>
    ...
    <style>
        * { font-family: 'Poppins', sans-serif; }
        ...
        .photo-upload-area { border: 2px dashed #e9d5ff; border-radius: 16px; padding: 40px 24px; text-align: center; cursor: pointer; transition: all 0.2s; background: #faf5ff; }
        ...
        .photo-upload-area p { font-size: 14px; color: #6b7280; margin: 0; }
        .photo-upload-area small { font-size: 12px; color: #9ca3af; }
        .photo-preview { display: none; margin-top: 12px; }
        .photo-preview img { max-height: 200px; border-radius: 12px; object-fit: cover; }
...
<body>
    ...
    <div class="page-header">
        ...
        <p>Capture a moment that matters to you</p>
    </div>
            ...
            <form action="{{ route('memories.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="Give this memory a name..." value="{{ old('title') }}" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group">
                    <div class="mood-options">
                        ...
                        <div class="mood-option">
                            <input type="radio" name="mood" id="mood_{{ $mood }}" value="{{ $mood }}" {{ old('mood') == $mood ? 'checked' : '' }} required>
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" class="form-control" rows="5" placeholder="Write about this memory... what happened? how did it feel? what made it special?" required>{{ old('description') }}</textarea>
                </div>
                ...
                <div class="form-group">
                    <div class="photo-upload-area" onclick="document.getElementById('photo').click()">
                        ...
                        <input type="file" id="photo" name="photo" accept="image/*" style="display:none;" onchange="handlePhoto(this)">
                    </div>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-primary-purple">🤎 save memory</button>
